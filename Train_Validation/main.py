from lib.networkNS import NetNS_InN_legendre, NetWave_InN_legendre, NetBurgers1D_InN_legendre
...
PROBLEM = 'NS' #'Burgers1D'#'Burgers2D' #'Wave'
...
def train_test_save():
    if PROBLEM == 'NS':
        ...
        dataset = Burgersn_Dataset2D(data_dir='./Data/', data_name='Burgers2D128Re100t1000', orders_train=orders_train,
                                 orders_test=orders_test,
                                 t_interval=t_interval)
        ...
        dataset = Burgersn_Dataset(data_dir='./Data/', data_name='Burgers128Re100t1000', orders_train=orders_train,
                                 orders_test=orders_test,
                                 t_interval=t_interval)
...
def load_test(out_name):
    ...
    if PROBLEM == 'NS':
        ...
        dataset = NS_Dataset2D(data_dir='./Data/', data_name='Burgers2D128Re100t1000'.format(Re),
        ...
        dataset = Burgersn_Dataset(data_dir='./Data/', data_name='Burgers128Re100t1000', orders_train=[],
                                 orders_test=orders_test,
                                 t_interval=t_interval)
